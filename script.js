...
// Gantilah seluruh bagian surahList di file script.js Anda dengan kode ini.
const surahList = [
    ...
    { number: 73, "Al-Muzzammil" }, { number: 74, "Al-Muddassir" }, { number: 75, "Al-Qiyamah" },
    { number: 76, "Al-Insan" }, { number: 77, "Al-Mursalat" }, { number: 78, "An-Naba'" },
    { number: 79, "An-Nazi'at" }, { number: 80, "'Abasa" }, { number: 81, "At-Takwir" },
