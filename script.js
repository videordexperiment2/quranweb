document.addEventListener('DOMContentLoaded', () => {
    ...
    const surahList = [
        ...
        { number: 82, name: "Al-Infitar" }, { number: 83, name: "Al-Mutaffifin" }, { number: 84, name: "Al-Insyiqaq" },
        { number: 85, name: "Al-Buruj" }, { number: 86, name: "At-Tariq" }, { number: 87, name: "Al-A'la" },
        { number: 88, name: "Al-Ghasyiyah" }, { number: 89, name: "Al-Fajr" }, { number: 90, name: "Al-Balad" },
        { number: 91, name: "Asy-Syams" }, { number: 92, name: "Al-Lail" }, { number: 93, name: "Ad-Duha" },
        { number: 94, name: "Asy-Syarh" }, { number: 95, name: "At-Tin" }, { number: 96, name: "Al-'Alaq" },
        { number: 97, name: "Al-Qadr" }, { number: 98, name: "Al-Bayyinah" }, { number: 99, name: "Az-Zalzalah" },
        { number: 100, name: "Al-'Adiyat" }, { number: 101, name: "Al-Qari'ah" }, { number: 102, name: "At-Takasur" },
        { number: 103, name: "Al-'Asr" }, { number: 104, name: "Al-Humazah" }, { number: 105, name: "Al-Fil" },
        { number: 106, name: "Quraisy" }, { number: 107, name: "Al-Ma'un" }, { number: 108, name: "Al-Kausar" },
