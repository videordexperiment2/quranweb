...
// === GANTI BAGIAN surahList ANDA DENGAN INI ===
const surahList = [
    ...
    { number: 67, name: "Al-Mulk" }, { number: 68, name: "Al-Qalam" }, { number: 69, "Al-Haqqah" },
    ...
    { number: 76, name: "Al-Insan" }, { number: 77, "Al-Mursalat" }, { number: 78, name: "An-Naba'" },
    { number: 79, name: "An-Nazi'at" }, { number: 80, name: "'Abasa" }, { number: 81, "At-Takwir" },
    ...
    { number: 112, "Al-Ikhlas" }, { number: 113, "Al-Falaq" }, { number: 114, name: "An-Nas" }
];
